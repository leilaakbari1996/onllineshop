          ...
          <div class="box-category">
            <ul id="cat_accordion">
                @foreach ($categories as $category)
                    <li><a href="category.html">{{$category->title}}</a>
                        @if ($category->has_children)
                            <span class="down"></span>
                            <ul>
                                @foreach ($category->children as $childCategory)
                                    <li><a href="category.html">{{$childCategory->title}}</a> <span class="down">
        ...
        <div id="content" class="col-sm-9">
                    ...
                    <div class="owl-carousel latest_category_tabs">
                        @foreach ($child->products as $product)
                            <div class="product-thumb">
                                <div class="image"><a href="{{route('client.products.show',$product)}}">
                                ...
                                <p class="price">
                                    ...
                                    @if ($product->has_discount)
                                       ...
                                       <span class="saving">-{{$product->discount->discount}}%</span>
                                    @endif
                                </p>
                                ...
                                <div class="add-to-links">
                                  ...
                                  <button type="button" class="wishlist" id="like-{{$product->id}}"
                                      onClick="
                                          like({{$product->id}})
                                      " data-toggle="tooltip" title="افزودن به علاقه مندی ها">
          ...
          <div class="owl-carousel latest_category_carousel">
             @foreach ($category->getallsubCategoryProduct() as $product)
                <div class="product-thumb">
                    <div class="image">
                        <a href="{{route('client.products.show',$product)}}"><img
                    ...
                    <div class="button-group">
                        <button class="btn-primary" type="button" onClick="addToCart({{$product->id}})">
          ...
          <div id="carousel" class="owl-carousel nxt">
            ...
            <div class="item text-center">
                {{$brand->name}}
                <a href="#"><img src="{{str_replace('public','/storage',$brand->image)}}"
