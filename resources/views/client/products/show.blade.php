    ...
    <div class="container">
      ...
      <ul class="breadcrumb">
        <li itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
            <a href="index.html" itemprop="url"><span itemprop="title"><i class="fa fa-home"></i>
            </span></a></li>
        <li itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
            <a href="category.html" itemprop="url"><span itemprop="title">{{$product->category->title}}</span></a></li>
        <li itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
            <a href="product.html" itemprop="url"><span itemprop="title">{{$product->name}}</span></a></li>
      </ul>
      <!-- Breadcrumb End-->
      <div class="row">
        <!--Middle Part Start-->
            ...
            <div class="row product-info">
              <div class="col-sm-6">
                 <div class="image">
                    ...
                    title="{{$product->image}}" alt="{{$product->image}}"
                ...
                <div class="image-additional" id="gallery_01">
                    ...
                    @foreach ($product->pictures as $picture)
                        <a class="thumbnail" href="#"
                            data-zoom-image="{{str_replace('public','/storage',$picture->image)}}"
                            data-image="{{str_replace('public','/storage',$picture->image)}}"
                            title="{{$picture->image}}">
                            <img src="{{str_replace('public','/storage',$picture->image)}}"
                            title="{{$picture->image}}" alt="{{$picture->image}}" />
                        </a>
                    @endforeach
                </div>
              </div>
              <div class="col-sm-6">
                ...
                <ul class="price-box">
                  <li class="price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                    ...
                    <span itemprop="price">{{$product->cost_with_discount}} تومان<span itemprop="availability" content="موجود"></span></span></li>
                  <li></li>
                  <li>بدون مالیات  تومان</li>
                </ul>
                <div id="product">
                ...
                <div class="addthis_toolbox addthis_default_style">
                    ...
                    pi:pinit:layout="horizontal" pi:pinit:url="http://www.addthis.com/features/pinterest" pi:pinit:media="http://www.addthis.com/cms-content/images/features/pinterest-lg.png"></a> <a class="addthis_counter addthis_pill_style"></a> </div>
...
<script type="text/javascript">
    ...
    $("#zoom_01").elevateZoom({
        ...
        lensFadeIn: 500,
        lensFadeOut: 500,
        loadingIcon: '/client/image/progress.gif'
        });
